'''
    Detectron2-compliant wrapper for Mask R-CNN.
		...
		"general": {
			...
			"DETECTRON2.MODEL.DEVICE": {
				...
				"options": {
					"cpu": {
						"name": "CPU",
						"description": "Run Mask R-CNN on the CPU and with system RAM."
					},
					"cuda": {
						"name": "GPU",
			...
			"config": {
				...
				"options": {
                    "COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_1x.yaml": {
						"name": "ResNet-50 (C4 1x), pre-trained on MS-COCO"
					},
                    "COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml": {
						"name": "ResNet-50 (C4 3x), pre-trained on MS-COCO"
					},
                    "COCO-InstanceSegmentation/mask_rcnn_R_50_DC5_1x.yaml": {
						"name": "ResNet-50 (Dilated C5 1x), pre-trained on MS-COCO"
					},
                    "COCO-InstanceSegmentation/mask_rcnn_R_50_DC5_3x.yaml": {
						"name": "ResNet-50 (Dilated C5 3x), pre-trained on MS-COCO"
					},
                    "COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_1x.yaml": {
						"name": "ResNet-50 (Feature Pyramid Network 1x), pre-trained on MS-COCO"
					},
                    "COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_1x_giou.yaml": {
						"name": "ResNet-50 (Feature Pyramid Network 1x gIoU), pre-trained on MS-COCO"
					},
                    "COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml": {
						"name": "ResNet-50 (Feature Pyramid Network 3x), pre-trained on MS-COCO"
					},
					"COCO-InstanceSegmentation/mask_rcnn_R_101_C4_3x.yaml": {
						"name": "ResNet-101 (C4 3x), pre-trained on MS-COCO"
					},
					"COCO-InstanceSegmentation/mask_rcnn_R_101_DC5_3x.yaml": {
						"name": "ResNet-101 (Dilated C5 3x), pre-trained on MS-COCO"
					},
                    "COCO-InstanceSegmentation/mask_rcnn_R_101_FPN_3x.yaml": {
						"name": "ResNet-101 (Feature Pyramid Network 3x), pre-trained on MS-COCO"
					},
                    "COCO-InstanceSegmentation/mask_rcnn_X_101_32x8d_FPN_3x.yaml": {
						"name": "ResNeXt-101 (Feature Pyramid Network 32x8d), pre-trained on MS-COCO"
					},

                    "LVISv1-InstanceSegmentation/mask_rcnn_R_50_FPN_1x.yaml": {
						"name": "ResNet-50 (Feature Pyramid Network 1x), pre-trained on LVIS v1"
					},
                    "LVISv1-InstanceSegmentation/mask_rcnn_R_101_FPN_1x.yaml": {
						"name": "ResNet-101 (Feature Pyramid Network 1x), pre-trained on LVIS v1"
					},
                    "LVISv1-InstanceSegmentation/mask_rcnn_X_101_32x8d_FPN_1x.yaml": {
						"name": "ResNeXt-101 (Feature Pyramid Network 32x8d), pre-trained on LVIS v1"
					},

                    "Cityscapes/mask_rcnn_R_50_FPN.yaml": {
						"name": "ResNet-50 (Feature Pyramid Network), pre-trained on Cityscapes"
					}
				}
			},
			"force": {
