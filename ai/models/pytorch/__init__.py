'''
    Generic AIWorker model implementation that supports PyTorch models.
...
from .functional.config.default import DEFAULT_OPTIONS
...
class PyTorchModel(AIModel):
    ...
    def __init__(self, config, dbConnector, fileServer, options):
        super(PyTorchModel, self).__init__(config, dbConnector, fileServer, options)
