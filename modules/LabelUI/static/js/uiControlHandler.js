...
class UIControlHandler {
    ...
    _setup_controls() {
        ...
        */
        ...
        loupeMarkup.append($('<button id="loupe-button" class="btn btn-sm btn-secondary" title="Toggle Loupe (B)"><img src="static/img/controls/loupe.svg" style="height:18px" /></button>'));
